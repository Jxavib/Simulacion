...
***7. Se pretende simular $nsim=10^4$ observaciones de una variable hypergemotrica (``dhyper(x,m,n,k)``) de parametros $m=$ dos últimas cifras del DNI , $n=100-m$ y $k=20$.***
...
```{r}
res <- table(hx)/nsim    # crea una tabla con lo elementos de hx y los divide para nsim
plot(res, ylab="frequencia relatica", xlab="valores") #grafica los valores simulados
points(x,fmp,pch=4,col='blue') #grafica los valores teoricos
```
